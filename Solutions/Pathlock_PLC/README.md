...
This project provides an ARM template to deploy the "Pathlock Cloud" connector in Microsoft Sentinel. The deployment includes the following components:
- Connector
- Parser Function
...
- Logs must be received in a custom table
- For now, following tables exit:
- - `Pathlock_PLC_EventLog_CL`.
...
[![Deploy to Azure](https://aka.ms/deploytoazurebutton)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Ffrozenstrawberries%2FAzure-Sentinel%2Fmaster%2FSolutions%2FPathlock_PLC%2FPackage%2FmainTemplate.json)
